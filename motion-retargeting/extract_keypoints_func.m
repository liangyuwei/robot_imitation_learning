function kp_id_list = extract_keypoints_func(l_wrist_pos, l_wrist_ori, l_elbow_pos, r_wrist_pos, r_wrist_ori, r_elbow_pos, l_glove_angle, r_glove_angle)
%% extract_keypoints_func.m
