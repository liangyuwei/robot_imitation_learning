...
% new_wrist_traj_l = h5read('tmp_new_paths_from_primitives.h5', '/l_approach_2_tmp'); %'/l_insert_2_tmp');
% new_wrist_traj_r = h5read('tmp_new_paths_from_primitives.h5', '/r_approach_2_tmp'); %'/r_insert_2_tmp');
