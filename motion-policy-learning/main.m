...
for i = 1 : size(l_x_start, 1)
    rotm = eul2rotm([l_eul_final(i, 3), l_eul_final(i, 2), l_eul_final(i, 1)]); % xyz for RViz, zyx for Matlab
    tmp = l_x_final' + rotm * [-0.1, 0, 0]';
    l_x_mid(i, :) = tmp';
end
