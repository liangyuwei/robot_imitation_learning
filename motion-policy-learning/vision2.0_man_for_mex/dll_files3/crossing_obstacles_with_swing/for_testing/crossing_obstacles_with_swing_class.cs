...
namespace crossing_obstacles_with_swing
{
  ...
  public class crossing_obstacles_with_swing_class : IDisposable
  {
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray crossing_obstacles_with_swing(MWArray traj_setting)
    {
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray crossing_obstacles_with_swing(MWArray traj_setting, MWArray motion_req)
    {
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray crossing_obstacles_with_swing(MWArray traj_setting, MWArray 
                                           motion_req, MWArray envionment_setting)
    {
    ...
    /// arguments.</returns>
    ///
    public MWArray[] crossing_obstacles_with_swing(int numArgsOut, MWArray traj_setting)
    {
