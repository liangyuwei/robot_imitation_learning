...
-crossing_obstacles_with_swing.dll
   -contains the generated component using MWArray API. 
-crossing_obstacles_with_swingNative.dll
...
crossing_obstacles_with_swing_overview.html - HTML overview documentation file for the 
...
crossing_obstacles_with_swing.xml - This file contains the code comments for the 
                                              crossing_obstacles_with_swing component 
