...
l_x_final = x_contact_origin' + eul2rotm([l_euler_final(3), l_euler_final(2), l_euler_final(1)]) * [-0.13, 0, 0]'; %[-0.01, 0, 0]'; %[-0.12, 0, 0]';
...
r_x_final = x_contact_origin' + eul2rotm([r_euler_final(3), r_euler_final(2), r_euler_final(1)]) * [-0.19, 0, 0]'; %[-0.01, 0, 0]'; %[-0.19, 0, 0]';
