function DataOut = perform_GMM_GMR_xw(Data, nbStates, nbVar, dt, nbData, nbSamples)
...
model.nbVar = nbVar; %4; % [t, x, y, z] %5; %Number of variables [t,x1,x2,x3,x4]
model.dt = dt; %1/200; % (1:1000) / 200 %0.01; %Time step duration
nbData = nbData; % 1000; %100; %Length of each trajectory
nbSamples = nbSamples; % 10; % 5; %Number of demonstrations
