function model = DMP_TPGMM(traj_dataset, nbData, nbStates, nbVar, nbVarPos, kP, kV, alpha, nbSamples, display)
...
model.nbVar = nbVarPos + 1; %4; %Number of variables [s,F1,F2] (decay term and perturbing force)
...
% nbSamples = 1; %4; %Number of demonstrations
...
%% Load imitation data and prepare
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% demos=[];
